    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Box my={4}>
        <Typography variant="h4" gutterBottom>
          Athlete Nutrition and Progress
        </Typography>
        
        {/* Progress Card */}
        <StyledCard>
          <CardContent>
            <Typography variant="h6">Progress Towards Weight Goal</Typography>
            <ProgressContainer>
              <CircularProgress variant="determinate" value={progressValue} size={100} thickness={4} />
              <ProgressLabel>{`${progressValue}%`}</ProgressLabel>
            </ProgressContainer>
          </CardContent>
        </StyledCard>
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell align="right">{macros.protein}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell component="th" scope="row">Carbohydrates</TableCell>
                <TableCell align="right">{macros.carbs}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell component="th" scope="row">Fats</TableCell>
                <TableCell align="right">{macros.fats}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell component="th" scope="row">Calories</TableCell>
                <TableCell align="right">{macros.calories}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </StyledTableContainer>
